  ...
  return (
    ...
    >
      <div className="container w-full mx-auto flex px-5 py-8 lg:py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left items-center text-left">
          ...
          {token ? (
            <div className="flex gap-[20px] flex-col lg:flex-row w-full max-w-[400px]">
              <Link className="w-full" to={`${routes.wallet.index}/${routes.wallet.spot.assets}`}>
                <ButtonUi className={`w-full h-[50px]`} variant="outlined">
                  My Wallet
                </ButtonUi>
              </Link>
              <Link
              ...
              >
                <ButtonUi className={`w-full h-[50px]`} variant="contained">
                  Invest in 3CO
                </ButtonUi>
              </Link>
            </div>
            ...
            <div
              className={`flex justify-center lg:justify-start flex-wrap w-full`}
            >
              <InputUi
              ...
              <ButtonUi
                ...
                variant={"contained"}
                className={classes.button + " ml-0 lg:ml-5"}
              >
                Register
              </ButtonUi>
            </div>
        ...
        <div className="hidden md:block lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
          <img
            className="object-center rounded w-full"
            alt="hero"
            src={imageUrl}
          />
        </div>
