    ...
    <>
      <section className={"body-font h-[700px] lg:h-full"}>
        <div className="container mx-auto flex md:flex-row flex-col items-center">
          <div className="lg:flex-grow w-full flex flex-col mb-16 md:mb-0 items-center">
            <div
              ...
              <div className={"flex w-full justify-between flex-wrap p-5"}>
                <div className={"flex flex-col w-full lg:w-[48%] flex-wrap"}>
                  <div className={"w-full lg:w-[100%]"}>
                    <Typography
                      className={"mb-3 font-[700] text-[1rem]"}
                      color={"text.primary"}
                    >
                    ...
                    <span
                      className={
                        "h-[30px] text-xs text-error flex items-center"
                      }
                    >
                ...
                <div className={"flex flex-col w-full lg:w-[48%] flex-wrap"}>
                  <div className={"w-full lg:mt-0"}>
                    <Typography
                      className={"mb-3 font-bold text-base flex"}
                      color={"text.primary"}
                    >
                      Coin{" "}
                      <Typography color={"textColor.gray"} className={"ml-2"}>
                        (Optional)
                      </Typography>
                    </Typography>
                    <Controller
                  ...
                  <div className={"w-full mt-4"}>
                    ...
                    <Controller
                      ...
                      control={control}
                      render={({ field }) => (
                        <InputUi {...field} className={classes.inputStyle} />
                      )}
                    />
                  </div>
                  <div className={"w-full mt-4"}>
                ...
                <div className={"w-full lg:w-[48%] mt-4"}>
                  ...
                  <div className={`rounded-[5px] ${classes.uploadBox}`}>
                    {fileValue?.file ? (
                      <div className={"py-[15px] px-[30px] "}>
                        <div
                          className={
                            "flex justify-between mb-[10px] items-center"
                          }
                        >
                          <div className={"flex"}>
                            <img
