      ...
      <Disclosure as="nav" className={"body-font " + classes.header}>
        {({ open }) => (
          <>
            <div
              className={
                "mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 border-0 border-b border-solid lg:border-0 " +
                classes.header
              }
            >
              <div className="relative flex h-16 items-center justify-between">
                <div className="absolute inset-y-0 right-0 flex items-center lg:hidden">
                  ...
                  <ButtonUi className={"mr-3"} sx={{ minWidth: "auto" }}>
                    <img src={NotificationsSvg} />
                  </ButtonUi>
                  {/* Mobile menu button*/}
                  <Disclosure.Button
                    className={
                      "border-0 inline-flex items-center justify-center rounded-md p-2 text-black " +
                      classes.buttonColor
                    }
                  >
                    {open ? (
